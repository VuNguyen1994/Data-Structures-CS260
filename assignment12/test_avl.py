#Mark Boady - CS260
#Test for AVL Binary Search Tree
...
def test_preorder():
	...
	s=T.preorder()
	s=s.strip()
	target="4 3 2 N N N 7 5 N 6 N N 9 N N"
	assert s==target
def test_postorder():
	T=make_tree([5,3,4,2,7,9,6])
	s=T.postorder()
	s=s.strip()
	target="N N 2 N 3 N N N 6 5 N N 9 7 4"
	assert s==target
